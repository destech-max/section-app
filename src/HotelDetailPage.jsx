...
// Simple inline social icons (lucide-react removed brand/logo icons)
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-8 pt-6">
        ...
        {/* Hero gallery — with overlapping action bar */}
        <div className="relative mb-16">
          ...
          {/* Floating action bar — bigger container, each button its own box */}
